...
//    Vec3<float> e0 = p1 - p0;
//    Vec3<float> e1 = p2 - p0;
//    Vec3<float> n = vec3::cross(direction_m, e1);
//    float det = vec3::dot(e0, n);
...
//    float u = vec3::dot(tvec, n) * invDet;
//    if(u < 0 || u > 1){
//        return std::nullopt;
//    }
//
//    Vec3<float> qvec = vec3::cross(tvec, e0);
//    float v = vec3::dot(direction_m, qvec) * invDet;
//    if(v < 0 || u + v > 1){
//        return std::nullopt;
//    }
//    float t = vec3::dot(e1, qvec) * invDet;
//    return {{u, v, t}};
//}
